      ...
      <HomeBannerWrapper>
        ...
        <SearchBar>
          <VerticalCenterAlignDiv>
            ...
            <SimpleMenu title="직무를 선택하세요" menuItems={['개발', '기획', '디자인']}></SimpleMenu>
          </VerticalCenterAlignDiv>
          <VerticalCenterAlignDiv>
            <SearchBarSpan>회사</SearchBarSpan>
            <SimpleMenu title="회사를 선택하세요" menuItems={['네이버', '삼성전자', 'JYP']}></SimpleMenu>
          </VerticalCenterAlignDiv>
          <VerticalCenterAlignDiv>
            <SearchBarSpan>태그</SearchBarSpan>
            <SimpleMenu title="태그를 선택하세요" menuItems={['취업준비', '이직', '사내 분위기']}></SimpleMenu>
          </VerticalCenterAlignDiv>
          <img src={BannerSearchIcon} alt="" />
        </SearchBar>
        <BannerTitle>평소 만나고 싶던<br />현직자를 만나보세요</BannerTitle>
      </HomeBannerWrapper>
    </HomeBannerFullWidthWrapper>
  );
}
